...
public class CrearPizza implements AmasarPizza, MoldeadorPizza, HorneadorPizza{
    ...
    public CrearPizza(String tamano, String ingredientes, String tipo, Integer coccion) throws InterruptedException {
        this.tamano = tamano;
    ...
    public String hornear() throws InterruptedException {
        System.out.println("Horneando Pizza "+ tipo +" coccinando unos " + coccion+ " minutos ");
