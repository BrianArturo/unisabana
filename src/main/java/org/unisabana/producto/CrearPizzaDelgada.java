...
public class CrearPizzaDelgada extends CrearPizza {
    ...
    public CrearPizzaDelgada(String tamano, String ingredientes, String tipo, Integer coccion) throws InterruptedException {
        this.tamano = tamano;
