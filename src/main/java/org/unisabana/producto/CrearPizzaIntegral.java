...
public class CrearPizzaIntegral extends CrearPizza {
    ...
    public CrearPizzaIntegral(String tamano, String ingredientes, String tipo, Integer coccion) throws InterruptedException {
        this.tamano = tamano;
    ...
    public String hornear() throws InterruptedException {
        System.out.println("Horneando Pizza "+ tipo +" co3cinando unos " + coccion+ " minutos ");
